Public Class join_t
    ...
    Protected Sub regSubmit_Click(sender As Object, e As EventArgs) Handles regSubmit.Click
        ...
        If (t_user.Count() > 0) Then
            ...
            Exit Sub
        End If
        adapter.Insert(Me.Tfname.Text, Me.Tlname.Text, Me.Tcompany.Text, Me.Tphone1.Text, Me.Tphone2.Text, "", Me.Temail.Text, Me.Taddress1.Text, Me.Taddress2.Text, Me.Tcity.Text, Me.Tstate.Text, Me.Tzip.Text, Me.Tusern.Text, Me.Tpassword1.Text, 1, 1, "TEST", Now.Date, Me.DLcountry.SelectedValue, Me.Tpin1.Text)
